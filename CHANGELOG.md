...
### Fixed
- El menú lateral ya no deja "Inicio" resaltado junto a la sección visitada: al entrar a Recursos, Entregables, Notas, Conversaciones, Evaluación Financiera, Calendario o el Quiz final, solo esa sección queda marcada
...
- El historial de la Evaluación Financiera ahora vive en la cuenta del asesor, no en el computador: los análisis guardados aparecen desde cualquier equipo donde inicie sesión, cada asesor ve únicamente los suyos, y la ficha sigue sin guardarse sola — solo persiste lo que se guarda con el botón
