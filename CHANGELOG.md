...
### Fixed
- Los comentarios de una clase o lección vuelven a verse cuando hay comentarios eliminados: la pestaña decía "1 comentario" y debajo no aparecía nada (ni el comentario ni el mensaje de "sé el primero en comentar"), porque los comentarios borrados seguían contándose aunque no se muestran. Ahora el contador refleja solo lo que se ve, y las respuestas eliminadas tampoco inflan el "N respuestas" de un hilo
