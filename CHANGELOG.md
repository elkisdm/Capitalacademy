...
### Added
- El equipo ya puede cambiar el orden de los módulos de un programa desde el panel, con flechas en cada módulo: antes solo se reordenaban las lecciones dentro de un módulo y mover el módulo mismo exigía tocar la base de datos, así que "Bienvenida" quedaba al final de la ruta de aprendizaje sin forma de subirla (`4306d04`)
...
### Changed
- Las clases en vivo se graban solas: la grabación arranca cuando entra la primera persona a partir de la hora de inicio, sin que nadie tenga que apretar nada ni depender de que el docente tenga cuenta en la plataforma. Si alguien la detiene a propósito, no se vuelve a encender sola (`f83dc09`)
