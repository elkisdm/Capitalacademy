...
- Reordenar las lecciones de un módulo desde el teléfono ya no provoca toques errados: los botones de subir/bajar tienen ahora tamaño táctil adecuado y la fila de cada lección se organiza en dos líneas claras (miniatura y título arriba, acciones abajo) en vez de amontonarse
- El detalle de un alumno en el panel administrativo ya no recorta las tarjetas de asistencia/avance/evaluaciones ni desordena las fechas de las sesiones a las que faltó
