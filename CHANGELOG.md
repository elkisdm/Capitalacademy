...
### Changed
- El menú del panel admin se reorganizó en dos grupos más claros: "General" (Usuarios, Cobros) y "Configuración" (Lecciones, Recursos, Quizzes, Progreso de cohorte), en vez de una sola lista "Operaciones" (`39e0e2f`)
