...
### Added
- La Evaluación Financiera ahora incluye los escenarios de dividendo de la calculadora: bajo el resultado aparece la matriz de plazos y pies calculada sobre el valor máximo estimado del cliente, con cada celda indicando si su renta alcanza — capacidad de compra y dividendo quedan en una sola pantalla
