...
- El reproductor de video ahora funciona bien en el teléfono: puedes arrastrar la barra de progreso con el dedo y el botón de pantalla completa funciona en iPhone
- Los formularios ya no hacen zoom involuntario al escribir en iPhone, y los botones e íconos pequeños ahora son fáciles de tocar en pantallas táctiles
- Se corrigieron desbordes y cortes de pantalla en móvil: pie del quiz, inicio del quiz, página de lección con títulos largos, footer de completar perfil, panel de alumnos del admin y verificación de certificados
- Las acciones que solo aparecían al pasar el mouse (editar o eliminar comentarios, copiar transcripción, remover roles) ahora son visibles en pantallas táctiles
