...
export default function PagoError({
  ...
  useEffect(() => {
    console.error("[pago] unhandled error:", error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      ...
      <p className="mt-2 max-w-sm text-[14px] text-ca-ink-soft">
        Ocurrió un error durante el proceso de pago. Tu transacción no fue
        procesada.
      </p>
      ...
      <p className="mt-4 text-[12px] text-ca-ink-soft">
        Si el problema persiste, contacta a{" "}
        <a
          href="mailto:soporte@capitalinteligente.cl"
          className="font-medium text-ca-violet underline"
        >
          soporte@capitalinteligente.cl
        </a>
      </p>
    </div>
  );
