/**
 * Shared SVG icon components for admin UI.
 * Extracted from user-profile-client, cohort-detail-client, and users-list-client
 * to avoid duplication across admin modules.
 */
...
export function TeacherIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      <path d="M17 3a2.85 2.85 0 114 4L7.5 20.5 2 22l1.5-5.5z" />
    </svg>
