  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-[rgba(20,22,58,0.08)] bg-white/95 px-4 pt-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] backdrop-blur-xl shadow-[0_-8px_24px_rgba(20,22,58,0.08)] md:hidden">
      <div className="mx-auto flex max-w-md items-center gap-3">
        <a
          href="#contacto"
          className="inline-flex h-11 flex-1 items-center justify-center rounded-full bg-[var(--color-ca-violet)] px-4 text-xs font-bold uppercase tracking-[0.14em] text-white shadow-[0_8px_20px_rgba(94,23,235,0.3)] transition-all active:scale-[0.98]"
        >
          Solicitar info
        </a>
        <a
          ...
          className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_20px_rgba(37,211,102,0.35)] transition-all active:scale-[0.95]"
        >
